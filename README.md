...
```javascript
 {
    "dev": {
        ...
        "runtime": "python3.7", // Python runtime to use on Lambda. Can be one of "python3.7", "python3.8", or "python3.9". Defaults to whatever the current Python being used is.
