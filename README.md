...
```javascript
 {
    "dev": {
        ...
        "capacity_provider_publish_to_latest_published": false, // When using capacity providers, publish a version to $LATEST.PUBLISHED after configuration updates. Default false.
